...
class MyGame(ShowBase):
    ...
    def update(self, task):
        ...
        self.camera.setPos(self.camera.getX() + x_movement, self.camera.getY() + y_movement, self.camera.getZ() + z_movement)

        if self.cameraSwingActivated:
            md = self.win.getPointer(0)
            mouseX, mouseY = md.getX(), md.getY()
            mouseChangeX = mouseX - self.lastMouseX
            mouseChangeY = mouseY - self.lastMouseY
            self.cameraSwingFactor = 10
            currentH, currentP = self.camera.getH(), self.camera.getP()
    ...
    def setupControls(self):
        self.keyMap = {"forward": False, "backward": False, "left": False, "right": False, "up": False, "down": False}
    ...
    def captureMouse(self):
        ...
        if self.mouseWatcherNode.hasMouse():
            md = self.win.getPointer(0)
            self.lastMouseX, self.lastMouseY = md.getX(), md.getY()
    ...
    def setupCamera(self):
        ...
        print("Kamera dan sistem deteksi tabrakan selesai diatur.")
